...
if ((process.env.REPORTS_BACKEND || "mongo").toLowerCase() === "fs") {
  ...
  try {
    ...
    // did the client actually send any answers?
    ...
    // only parse when provided; otherwise keep empty to avoid zeroing
    ...
    // cumulative: recalc FY up to current month
    let cumulative84Obj;
